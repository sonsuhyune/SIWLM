...
BERT_PATH="checkpoints_qnli/qnli_adamax_5e-5_2020-08-23T2124/qnli_pretrain.pt"
DATA_DIR="data/canonical_data/new_bert_base_uncased_lower"
...
model_dir="${MODEL_ROOT}/weight6_small_${lr}_${BATCH_SIZE}_${GRAD_ACC_STEPS}_${prefix}"
