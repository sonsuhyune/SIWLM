...
BERT_PATH="checkpoints_mnli_matched,mnli_mismatched/mnli_matched,mnli_mismatched_adamax_5e-5_2020-09-02T1035/mnli_pretrain.pt"
...
model_dir="${MODEL_ROOT}/fine_${lr}_${BATCH_SIZE}_${GRAD_ACC_STEPS}_${prefix}_${tstr}"
