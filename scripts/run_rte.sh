...
BERT_PATH="checkpoints_rte/rte_adamax_5e-5_2020-10-22T1054/strip_model.pt"
...
model_dir="checkpoints/fine_${prefix}_${optim}_answer_opt${answer_opt}_gc${grad_clipping}_ggc${global_grad_clipping}_${tstr}"
